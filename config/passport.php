...
return [
    ...
    */
    ...
    'private_key' => env('PASSPORT_PRIVATE_KEY', file_get_contents('storage/oauth-private.key')),

    'public_key' => env('PASSPORT_PUBLIC_KEY', file_get_contents('storage/oauth-public.key')),
